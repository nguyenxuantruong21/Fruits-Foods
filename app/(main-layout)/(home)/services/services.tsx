      ...
      <div className="container">
        <div className="grid-cols-3 grid gap-10">
          <Card className="rounded-2xl border-[1px] border-secondaryColor">
            ...
            <CardFooter className="bg-secondaryColor py-20 relative rounded-b-2xl">
              <div
                className={cn(
                  "bg-primaryColor w-[60%] mx-auto rounded-[10px] px-20 py-14 absolute top-0 left-0 right-0 transform -translate-y-1/2 text-center",
                  "flex flex-col gap-8"
                )}
              >
          ...
          <Card className="rounded-2xl border-[1px] border-slate-700">
            ...
            <CardFooter className="bg-slate-700 py-20 relative rounded-b-2xl">
              <div
                className={cn(
                  "bg-white w-[60%] mx-auto rounded-[10px] px-20 py-14 absolute top-0 left-0 right-0 transform -translate-y-1/2 text-center",
                  "flex flex-col gap-8"
                )}
              >
          ...
          <Card className="rounded-2xl border-[1px] border-primaryColor">
            ...
            <CardFooter className="bg-primaryColor py-20 relative rounded-b-2xl">
              <div
                className={cn(
                  "bg-secondaryColor w-[60%] mx-auto rounded-[10px] px-20 py-14 absolute top-0 left-0 right-0 transform -translate-y-1/2 text-center",
                  "flex flex-col gap-8"
                )}
              >
                <h2 className="text-[2rem] font-[600] text-white">
